...
class CoinFlip:
    ...
    def __init__(self):
        ...
        self.text = widgets.Text(
            value="", placeholder="", description="String:", disabled=False
        )
...
# initial transition
t0 = {"source": "initial", "target": "spinning"}

# compound transition
t1 = {"trigger": "flip", "source": "spinning", "target": "heads"}
#      'function': coin_flip.flip_compound_transition}

t2 = {"trigger": "t", "source": "heads", "target": "spinning"}

t3 = {"trigger": "t", "source": "tails", "target": "spinning"}

# Change 3: We declare dicts for the states
spinning = {"name": "spinning", "entry": "on_spinning"}

heads = {"name": "heads", "entry": "on_heads;start_timer"}

tails = {"name": "tails", "entry": "on_tails;start_timer"}
