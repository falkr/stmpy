...
class TerminateTestCase(unittest.TestCase):
    ...
    def test(self):
        ...
        stm_terminate = Machine(
            name="stm_terminate", transitions=[t0, t1], obj=terminate
        )
...
class DeferTestCase(unittest.TestCase):
    def test(self):
        ...
        stm_terminate = Machine(
            name="stm", transitions=[t0, t1, t2], states=[s1, s2], obj=None
        )
        # terminate.stm = stm_terminate
...
class TestTick(unittest.TestCase):
    def test(self):
        ...
        print(
            "driver state: active {} and thread alive {} ".format(
...
class ToPromela(unittest.TestCase):
    def test(self):
        ...
        stm_tick = stmpy.Machine(
            name="stm_tick", transitions=[t0, t1, t2, t3], obj=None
        )
        to_promela([stm_tick])
        # raise Exception
